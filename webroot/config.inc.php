...
define('UC_DBPW', '5iyaya');					// UCenter 数据库密码
define('UC_DBNAME', 'discuz');				// UCenter 数据库名称
define('UC_DBCHARSET', 'utf8');				// UCenter 数据库字符集
define('UC_DBTABLEPRE', 'discuz.uc_');			// UCenter 数据库表前缀

//通信相关
define('UC_KEY', '123456789');				// 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'http://localhost/php/discuz/ucenter');	// UCenter 的 URL 地址, 在调用头像时依赖此常量
