...
strFrame='<style>';
strFrame+='INPUT.button{BORDER-RIGHT: #3992DA 1px solid;BORDER-TOP: #3992DA 1px solid;BORDER-LEFT: #3992DA 1px solid;';
strFrame+='BORDER-BOTTOM: #3992DA 1px solid;BACKGROUND-COLOR: #74CBF5;font-family:宋体;}';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 width=142 height=160 bordercolor=#3992DA bgcolor=#3992DA Author="wayx">';
...
strFrame+='      <tr align=center Author="wayx"><td width=16 align=center bgcolor=#3992DA style="font-size:12px;cursor: hand;color: #ffffff" ';
strFrame+='        onclick="parent.meizzPrevM()" title="向前翻 1 月" Author=meizz><b Author=meizz>&lt;</b>';
strFrame+='        </td><td width=60 align=center style="font-size:12px;cursor:default" Author=meizz ';
strFrame+='onmouseover="style.backgroundColor=\'#74CBF5\'" onmouseout="style.backgroundColor=\'white\'" ';
...
strFrame+='<td width=48 align=center style="font-size:12px;cursor:default" Author=meizz onmouseover="style.backgroundColor=\'#74CBF5\'" ';
strFrame+=' onmouseout="style.backgroundColor=\'white\'" onclick="parent.tmpSelectMonthInnerHTML(this.innerText.length==3?this.innerText.substring(0,1):this.innerText.substring(0,2))"';
strFrame+='        title="点击这里选择月份"><span id=meizzMonthHead Author=meizz></span></td>';
strFrame+='        <td width=16 bgcolor=#3992DA align=center style="font-size:12px;cursor: hand;color: #ffffff" ';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 bgcolor=#3992DA ' + (bMoveable? 'onmousedown="DragStart()" onmouseup="DragEnd()"':'');
strFrame+=' BORDERCOLORLIGHT=#3992DA BORDERCOLORDARK=#FFFFFF width=140 height=20 Author="wayx" style="cursor:' + (bMoveable ? 'move':'default') + '">';
...
strFrame+='    <table border=1 cellspacing=2 cellpadding=0 BORDERCOLORLIGHT=#3992DA BORDERCOLORDARK=#FFFFFF bgcolor=#FFFFFF width=140 height=120 Author="wayx">';
...
strFrame+='         Author=meizz title="' + _VersionInfo + '"><u><b>关闭</b></u></span>&nbsp;</td></tr>';
...
function meizzToday()  //Today Button
  {
    ...
    //meizzSetDay(meizzTheYear,meizzTheMonth);
    if(outObject){
		outObject.value=meizzTheYear + "年" + meizzTheMonth + "月" + today+"日";
    }
    closeLayer();
  }
      ...
      { 
		...
		if(i<firstday)		//上个月的部分
		{
			...
			else
			{
				...
				meizzWDay[i] == new Date().getDate()) ? "#74CBF5":"#e0e0e0");
				//将选中的日期显示为凹下去
				if((mm==1?yy-1:yy)==outDate.getFullYear() && (mm==1?12:mm-1)== outDate.getMonth() + 1 && 
				meizzWDay[i]==outDate.getDate())
				{
					da.borderColorLight="#FFFFFF";
					da.borderColorDark="#3992DA";
				}
			}
		}
...
function meizzDayClick(n,ex)  //点击显示框选取日期，主输入函数*************
{
  ...
  if (outObject)
  {
    if (!n) {//outObject.value=""; 
      return;}
    if ( n < 10){n = "0" + n;}
    outObject.value= yy + "年" + mm + "月" + n + "日" ; //注：在这里您可以输出改成您想要的格式
    closeLayer(); 
  }
