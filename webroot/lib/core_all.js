...
var __jqueryhoverIntent__ = true ;
/*
...
window["component.Gallery"]=function( elem ){
	...
	$elem.prepend( '<img class="big_picture" src="' + no_picture + '" />' )  ;
