 ...
 * 
 * @author:daodao
 * @version $Id: Money.java,v 1.1 2008/07/11 00:47:11 fred Exp $
 */
public class Money implements Serializable, Comparable {

	private static final long serialVersionUID = 6938696606407358869L;
	...
	public Money(BigDecimal amount, Currency currency, int roundingMode) {
		this.currency = currency;
		this.cent = rounding(amount.movePointRight(currency
