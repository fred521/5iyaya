 ...
 * 
 * @version $Rev: 350169 $, $Date: 2009/01/17 06:05:06 $
 */
...
public class ExecutorFilter extends IoFilterAdapter {
	 ...
	 *            IoSession object
	 * @param type
	 *            Event type (opened, closed, read, written, etc)
	 * @param data
	 *            Data
	 */
	 ...
	 * 
	 * @param nextFilter
	 *            Next filter in queue
	 * @param session
	 *            IoSession object (connection between two ends)
	 * @param type
	 *            Event type
	 * @param data
	 *            Event data
